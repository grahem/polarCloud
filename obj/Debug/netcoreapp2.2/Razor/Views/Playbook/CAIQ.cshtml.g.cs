#pragma checksum "C:\Users\devel\StudioProjects\polarCloud Web\polarCloudWeb\Site\Site\Views\Playbook\CAIQ.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ccc42c33ae91d01e576fcecb715ef9e9a06b5d06"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Playbook_CAIQ), @"mvc.1.0.view", @"/Views/Playbook/CAIQ.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Views/Playbook/CAIQ.cshtml", typeof(AspNetCore.Views_Playbook_CAIQ))]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ccc42c33ae91d01e576fcecb715ef9e9a06b5d06", @"/Views/Playbook/CAIQ.cshtml")]
    ...
    public class Views_Playbook_CAIQ : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "C:\Users\devel\StudioProjects\polarCloud Web\polarCloudWeb\Site\Site\Views\Playbook\CAIQ.cshtml"
...
#line hidden
            ...
            EndContext();
            BeginContext(75, 1188, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ccc42c33ae91d01e576fcecb715ef9e9a06b5d063961", async() => {
                BeginContext(81, 1175, true);
                WriteLiteral(@"
        <meta charset=""utf-8"">
        ...
        <link href=""/lib/l");
            ...
            WriteLiteral("\r\n\r\n    ");
            EndContext();
            BeginContext(1271, 36277, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ccc42c33ae91d01e576fcecb715ef9e9a06b5d066427", async() => {
                BeginContext(1324, 36217, true);
                WriteLiteral(@"
        <div style=""margin-top: 120px"">
            ...
            <P>Are all of your network operations conducted over a secure laye");
                WriteLiteral(@"r (TLS)?
            ...
            <P>How is staff trained to");
                WriteLiteral(@" handle service outages?
            ...
            <P>Do you allow tenants to specify which of your geographic locations their data is allowed to move into/out of (to address legal jurisdictional consider");
                WriteLiteral(@"ations based on where data is stored vs. accessed)?
      ...
      ");
                WriteLiteral(@"      <P>Do you leverage encryption to protect data and virtual machine images during transport across and between networks and hypervisor instances?
            ...
            <P> Do you have documented information security baselines for every component of your infrastructure (e.g., hypervisors, operating systems, routers, DNS servers,");
                WriteLiteral(@" etc.)?
            ...
            <P> Do you provide tenants with documentation describing your ");
                WriteLiteral(@"Information Security Management Program (ISMP)?
            ...
            <P> Are employees made aware of what actions could be taken in the event of a violation via their po");
                WriteLiteral(@"licies and procedures?
            ...
            <P> Do you make a");
                WriteLiteral(@"vailable documentation of your organization-wide risk management program?
            ...
            <P> Is successful and timed completion of the training program considered a prerequisite for acquiring and maintaining acces");
                WriteLiteral(@"s to sensitive systems?
            ...
            <P> Do you provide tenants with a rol");
                WriteLiteral(@"e definition document clarifying your administrative responsibilities versus those of the tenant?
            ...
            <P> Are users made aware of their responsibilities for maintaining awareness and compliance with publish");
                WriteLiteral(@"ed security policies, procedures, standards, and applicable regulatory requirements?
            ...
            <P> Do you monitor and log");
                WriteLiteral(@" privileged access (e.g., administrator level) to information security management systems?
            ...
            <P> Are controls in place to prevent unauthorized access to your application, program");
                WriteLiteral(@", or object source code, and assure it is restricted to authorized personnel only?
            ...
            <P> Do you have a method");
                WriteLiteral(@" of aligning provider and tenant data classification methodologies for access control purposes?
            ...
            <P> Will you share user entitl");
                WriteLiteral(@"ement remediation and certification reports with your tenants, if inappropriate access may have been allowed to tenant data?
            ...
            <P> Do you have a Policy Enforcement Point capability (");
                WriteLiteral(@"e.g., XACML) to enforce regional legal and policy constraints on user access?
            ...
            <P> Do you have mechanisms in place for unlocking accounts that have been locked out (e.g., self-service via email, defined challenge q");
                WriteLiteral(@"uestions, manual unlock)?
            ...
            <P> Are audit logs reviewed on a regular basis f");
                WriteLiteral(@"or security events (e.g., with automated tools)?
            ...
            <P> Do your system capacity requirements take into account current, projected, and anticipated capacity needs for all systems used to provide services to the tena");
                WriteLiteral(@"nts?
            ...
            <P> Are operating systems hardened to provide only the necessary ports, protocols, an");
                WriteLiteral(@"d services to meet business needs using technical controls (e.g., antivirus, file integrity monitoring, and logging) as part of their baseline build standard or template?
            ...
            <P> Are system and network environments protected by a firewall or virtual firewall to ensure separation of production and non-producti");
                WriteLiteral(@"on environments?
            ...
            <P> Are policies and procedures established and mechanisms configured and implemented to protect the wireless network environment perimeter and to restric");
                WriteLiteral(@"t unauthorized wireless traffic?
            ...
            <P> Do you implement technical measures and apply defense-in-depth techniques (e.g., deep packet analysis, traffic throttling and black-holing) for detection and timely response to network-based attacks associated with anomalous ingress or egress traffic patterns (e.g., MAC spoofing and ARP poisoning attacks)");
                WriteLiteral(@" and/or distributed denial-of-service (DDoS) attacks?
   ...
   ");
                WriteLiteral(@"         <P> Do you use an industry-recognized virtualization platform and standard virtualization formats (e.g., OVF) to help ensure interoperability?
            ...
            <P> Do you have a documented mobile device polic");
                WriteLiteral(@"y in your employee training that clearly defines mobile devices and the accepted usage and requirements for mobile devices?
            ...
            <P> Does your mobile device policy require the us");
                WriteLiteral(@"e of encryption for either the entire device or for data identified as sensitive enforceable through technology controls for all mobile devices?
            ...
            <P> Do you manage all changes to mobile device operating sys");
                WriteLiteral(@"tems, patch levels, and applications via your company's change management processes?
            ...
            <P> Do your");
                WriteLiteral(@" mobile devices have the latest available security-related patches installed upon general release by the device manufacturer or carrier?
            ...
            <P> Have you tested ");
                WriteLiteral(@"your security incident response plans in the last year?
            ...
            <P> Do you monitor and quantify the types, vo");
                WriteLiteral(@"lumes, and impacts on all information security incidents?
            ...
            <P> Do you perform annual internal assessments of conformance and effectiveness of your policies, ");
                WriteLiteral(@"procedures, and supporting measures and metrics?
            ...
            <P> Are policies and procedures established, and supporting business processes and technical measures implemented, for maintaining complete, accurate, and relevant agreements (e.g., SLAs) betw");
                WriteLiteral(@"een providers and customers (tenants)?
            ...
            <P> Do you have anti-malware programs that support or connect to your cloud service offer");
                WriteLiteral(@"ings installed on all of your systems?
            ...
            <P> Is mobile code authorized before its");
                WriteLiteral(@" installation and use, and the code configuration checked, to ensure that the authorized mobile code operates according to a clearly defined security policy?
